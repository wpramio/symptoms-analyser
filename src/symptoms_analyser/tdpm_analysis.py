...
def main():
    ...
    try:
        ...
        # Generate eval_id here so it's available to the except block for failure telemetry
        ...
        # Persist scoring results to SQLite
        ...
        if db_conn:
            try:
                ...
                # Record failure in evaluation_telemetry so the admin dashboard sees it
                cursor.execute("""
                ...
                # Also mark the transcript itself as failed
                cursor.execute("""
                    UPDATE transcripts 
