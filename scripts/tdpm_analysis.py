...
Usage:
    python scripts/tdpm_analysis.py <sanitized_transcript.txt> [--output output.json] [--blocks-per-call N]
...
PROMPT_FILE = Path(__file__).resolve().parents[1] / "prompts" / "tdpm_analysis.md"
ONTOLOGY_FILE = Path(__file__).resolve().parents[1] / "data" / "tdpm_ontology.json"
